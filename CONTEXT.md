...
- Main site: index.html + assets/css/style.css
...
- Real hello: `./heyCopilot speak --debug` (will prompt for PROJECT_API_KEY; defaults to edw endpoint)
- Smoke test: `USER_ENDPOINT="..." MODEL_DEPLOYMENT_NAME="gpt-4.1-mini" ./heyCopilot speak --dry-run` or `python Agentcy/scripts/foundry_smoke_test.py`
...
- Quick check: `python3 -m py_compile Agentcy/scripts/hey_copilot.py`

## CI
- .github/workflows/ci.yml runs pytest with Agentcy/requirements.txt.
