...
const CLASSIC_ARCHIVE_NOTE = 'Classic archive runs stay local in this public snapshot.';

if (dom.lbTabs) {
  dom.lbTabs.hidden = true;
}
if (dom.lbList) {
  dom.lbList.textContent = CLASSIC_ARCHIVE_NOTE;
}
